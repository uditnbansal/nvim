...
keymap.set('n', '<Leader>Fa', ':Autoformat<CR>')
...
keymap.set('n', '<Leader>fh', telescope_builtin.help_tags, {})
keymap.set('n', '<Leader>fr', telescope.extensions.repo.cached_list, {})
...
keymap.set('n', '<Leader>gph', ':Gpush<CR>')
keymap.set('n', '<Leader>gpl', ':Gpull<CR>')
